...
export default function createSVGfromTemplate({
  ...
  return `<svg width="270" height="270" viewBox="0 0 270 270" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <g id="g10" transform="translate(25,-110)">
      <g id="g12" transform="scale(0.025)">
        <path id="path16" style="fill:white" class="st0" d="M970,6554.7l105.9,183.3l42.4,73.1l147.4-255.1l-148.2-256.7
          L970,6554.7z M1378.9,5935.6H612.6l207.8,359.8l128.4-222.8c13.7-19.6,33.3-33.3,58.7-33.3h260.3l297.4,516.6l-279.8,481.4
          c-11.8,19.6-31.3,33.3-56.8,33.3H968.3l-148-256.6l-208.1,360.4h767.1l357.5-618.4L1378.9,5935.6z M1546.9,7399.4
          c-11.7,21.5-31.3,33.3-56.8,33.3H279.4c-23.5,0-45-11.7-56.8-33.3c-11.7-21.5-11.7-45,0-66.5l448.2-778l-283.8-492.1l-164.4-285.7
          c-11.7-21.5-11.7-45,0-66.5c11.7-21.5,33.3-33.3,56.8-33.3h1210.7c25.4,0,45,11.7,56.8,33.3l489.2,845.4L1546.9,7399.4"/>
      </g>
    </g>
    ${
      isNormalized
